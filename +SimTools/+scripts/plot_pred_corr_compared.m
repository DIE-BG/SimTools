...
for var = 1 : length(list)
    ...
    SimTools.scripts.die_anotaciones( ...
        ...
        MODEL.F_pred.(list{var})(params.AnnoRange), ...
        string(num2str(MODEL.F_pred.(list{var})(params.AnnoRange), '%0.2f')), ...
        'Container', plot_p, ...
        'Color', 'b', ...
    ...
    if ~isempty(params.FullDataAnt_Name)
        SimTools.scripts.die_anotaciones( ...
            dat2dec(params.AnnoRange)', ...
            full_data_ant.(list{var})(params.AnnoRange), ...
            string(num2str(full_data_ant.(list{var})(params.AnnoRange), '%0.2f')), ...
            'Container', plot_p, ...
            'Color', 'r', ...
            'IsAnt', true, ...
            'XAdjustment', params.AnnotationXAdjustment, ...
